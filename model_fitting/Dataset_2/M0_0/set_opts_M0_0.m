...
if ~(opts.model==1), opts.ix(6:9) = 0; end
if ~opts.lambda, opts.ix(3) = 0; end
if ~opts.eta, opts.ix(4) = 0; end
if ~opts.kappa, opts.ix(5) = 0; end
if ~opts.st, opts.ix(10) = 0; end
if ~opts.respst, opts.ix(11) = 0; end
