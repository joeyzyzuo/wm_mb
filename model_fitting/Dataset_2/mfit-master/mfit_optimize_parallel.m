        ...
        for i = 1:nstarts
            if all(isinf(lb)) && all(isinf(ub))
                ...
                for k = 1:K
                    ...
                    if x0(k)<param(k).lb || x0(k)>param(k).ub;
                        dsadsa=124
                    end
                end
...
%                 if isnan(-mfit_post(x0,param,data(s),likfun))
%                     -mfit_post(x0,param,data(s),likfun);
%                 end
...
[fasf, safas]=likfun(x_out(s,:),data(s));